...
class Jetpack {
	...
	private function __construct() {
		...
		$rest_authentication = new Connection_Rest_Authentication();
		add_filter( 'determine_current_user', array( $rest_authentication, 'wp_rest_authenticate' ) );
		add_filter( 'rest_authentication_errors', array( $rest_authentication, 'wp_rest_authentication_errors' ) );
...
<div id="message" class="jetpack-message jetpack-err">
	...
	public function reset_saved_auth_state() {
		...
		return ( new Connection_Rest_Authentication() )->reset_saved_auth_state();
	}
	...
	function wp_rest_authenticate( $user ) {
		...
		return ( new Connection_Rest_Authentication() )->wp_rest_authenticate( $user );
	}
	...
	public function wp_rest_authentication_errors( $value ) {
		...
		return ( new Connection_Rest_Authentication() )->wp_rest_authentication_errors( $value );
	}
